...
export default function About() {
  return (
    <section
      className="grid grid-cols-1 items-center gap-14 lg:grid-cols-[1fr_auto] lg:justify-items-end"
      id="sobre"
    >
      <div>
        ...
        <h2 className="text-xl font-bold text-zinc-500 sm:text-3xl lg:text-2xl xl:text-3xl">
